...
def parser_add_main_args(parser):
    ...
    parser.add_argument('--graph_weight', type=float, default=0.5, help='graph weight in augmentation. 0 means not use graph.')
    ...
    #augTrain
    parser.add_argument('--aug_type', type=int, default=0, help='0: use 1 layer, 1: use all layers')
    parser.add_argument('--label_grad', action='store_true', help='take gradients w.r.t pseudolabels')
    parser.add_argument('--no_label_aug', action='store_true', help='Not augment labels.')
    parser.add_argument('--conf_thresh', type=float, default=0,help='confidence threshold')
    parser.add_argument('--moving', type=float, default=0.5,help='confidence threshold')
    parser.add_argument('--aug_lamb', type=float, default=1,help='Augmentation loss weight.')
    parser.add_argument('--sup_alpha', type=float, default=1,help='Supervisatioin loss weight.')
    parser.add_argument('--aug_skip', action='store_true', help='Add skip connection during gcn augmentation.')
    parser.add_argument('--alpha', type=float, default=0.5,help='Skip weight in APP_GCN augmentation.')

    #mixup
    parser.add_argument('--lamb', type=float, default=0.5,help='lambda for mixup')
    ...
    parser.add_argument("--num_event", type=int, default=10)
    # pileup transfer
    parser.add_argument("--src_event", type=int, default=10)
    parser.add_argument("--tgt_event", type=int, default=10)
    parser.add_argument("--src_pu", type=int, default=10)
    parser.add_argument("--tgt_pu", type=int, default=30)
    parser.add_argument("--src_sig", type=str, default='gg', help='src signal, can be gg or qq')
    parser.add_argument("--tgt_sig", type=str, default='gg', help='tgt signal, can be gg or qq')
